...
<script>
    export default {
        ...
        mounted() {
            //推荐课程
            this.axios.get('http://web.blog.com:8080/api/commendLesson/4').then((response) => {
                this.commendLesson = response.data.data;
            })
            //热门课程
            this.axios.get('http://web.blog.com:8080/api/hotLesson/4').then((response) => {
        ...
        data() {
            return {
                ...
                slides: [
                    ...
                    {id: 2, path: 'static/images/1.jpg'},
                    {id: 3, path: 'static/images/1.jpg'}
                ],
                swiperOption: {
                    slidesPerView: 'auto',
                    spaceBetween: 30,
